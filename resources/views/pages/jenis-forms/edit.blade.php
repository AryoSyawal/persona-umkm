...
<div class="page-body">
  <div class="container-xl">
    <div class="row row-cards">
      <div class="col-12">
        <form action="{{ route('superadmin.jenis-form.update', $jenis_form->id) }}" method="POST" class="card" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="nama_form" value="{{ $jenis_form->nama_form }}" placeholder="Masukan nama form">
